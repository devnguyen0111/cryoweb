...
import { LayoutDashboard, Calendar, Users, Pill, FlaskConical, FileText, Plus, Search, Filter } from 'lucide-react'
...
function DoctorPrescriptionsPage() {
    return (
        <RoleBasedRoute allowedRoles={['Doctor']} currentPath="/doctor/prescriptions">
                ...
                <div className="container mx-auto px-6 py-8">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Recent and active prescriptions</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="text-center py-12 text-muted-foreground">
                                <Pill className="h-12 w-12 mx-auto mb-4 opacity-50" />
                                <p>Connect to API to view prescriptions</p>
                                <p className="text-sm mt-2">Prescription list will be displayed here</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
