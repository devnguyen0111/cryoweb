...
function ReceptionistTransactionsPage() {
    return (
        <RoleBasedRoute allowedRoles={['Receptionist']} currentPath="/receptionist/transactions">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-12 text-muted-foreground">
                                    ...
                                    <p>Connect to API to view transactions</p>
                                    <p className="text-sm mt-2">Transaction list will be displayed here</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-center py-12 text-muted-foreground">
                                    ...
                                    <p>Connect to API to view pending payments</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
